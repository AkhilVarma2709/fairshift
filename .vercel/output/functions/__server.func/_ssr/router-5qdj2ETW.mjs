...
var Route$1 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Upload shift data, measure fairness, and generate a more balanced next-week schedule."
			},
			{
				name: "author",
				content: "FairShift"
			...
			},
			{
				...
				content: "A simple scheduler workspace for fairness analysis, stress reduction, and next-week planning."
			},
			{
				property: "og:type",
				content: "website"
...
var rootRouteChildren = { IndexRoute: createFileRoute("/")({
	head: () => ({ meta: [{ title: "FairShift" }, {
		name: "description",
		content: "Upload CSV files, compare fairness before and after optimization, and view next week's schedule."
	}] }),
